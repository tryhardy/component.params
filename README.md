...
# <a id='t1'>Описание</a>
Простой модуль для настройки параметров компонентов без необходимости хранить значения параметров в отдельной таблице в БД (как это делается сейчас в uplab.flexiblock).
